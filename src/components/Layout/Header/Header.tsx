    ...
    <nav className="bg-secondary-300 py-3">
      <div className="container">
        <div className="flex items-center justify-between">
          <Link
            href={homeUrl}
            className="text-white font-semibold text-lg flex items-center gap-2 uppercase"
          >
          ...
          <div className="hidden md:flex md:items-center space-x-10">
            ...
            <div className="relative">
              <button onClick={toggleDropdown} className={classNames(linkCls)}>
                Categories
              </button>
              {isDropdownOpen && (
                <CategoriesDropdown setDropdownOpen={setDropdownOpen} />
              )}
            </div>
            ...
            >
              ...
              <AiOutlineLogin
                className={classNames(
                  linkCls,
                  "relative top-[1px] text-[20px] group-hover:text-primary-100"
                )}
              />
            </Link>
            ...
            {session?.user?.email && (
              ...
              >
                <div
                  className="text-primary-100 hover:text-white trans flex items-center gap-2"
                  onClick={toggleMenuDropdown}
                >
                  {session.user.name || session.user.email}{" "}
                  <BsChevronDown className="relative top-[1px]" />
                </div>
      ...
      {/* mobile navbar menu */}
      <div
        className={`navbar-menu relative md:z-[99] z-[999] lg:hidden ${
