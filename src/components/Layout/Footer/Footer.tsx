...
const Footer = () => {
  return (
    <footer className="bg-primary-400 rounded text-center text-white lg:text-left mt-10">
      <div className="container">
          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 xll:grid-cols-4">
            <div className="">
              ...
              <p className="text-white">
                Customization is the name of the game. You will find a vast
                array of top-tier components from leading manufacturers
                worldwide, allowing customers to build their dream PC from
                scratch.
              </p>
            </div>
            ...
            <div className="">
              ...
              <p className="mb-4 flex items-center justify-center md:justify-start gap-1 text-white">
                <CiLocationArrow1 />
        ...
        <div className="p-6 text-center">
          <span>
            © 2023 Copyright:{" "}
            <Link className="font-semibold text-white" href={homeUrl}>
              PC Crafts
            </Link>
          </span>
        </div>
